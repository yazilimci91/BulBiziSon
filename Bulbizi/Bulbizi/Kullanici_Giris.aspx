<%@ Page Title="" Language="C#" MasterPageFile="~/AnaMaster.Master" AutoEventWireup="true" CodeBehind="Kullanici_Giris.aspx.cs" Inherits="Bulbizi.Kullanici_Giris" %>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            ...
            <div class="login-page">
                <div class="container">
                    <h3 class="w3ls-title w3ls-title1">Giriş Yap  |  Kullanıcı </h3>
